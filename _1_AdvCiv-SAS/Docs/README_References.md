...
- Kathy's Mod 1.2026: Ana Nzinga 03 ([Michaelle_Jean]), Salamasina 13 ([Shin_Sawbu], [SalmasinaFinal_Inverted].nif) (note: `[Name_With_Underscores]` denotes the folder/filename as-is; display name uses spaces)
